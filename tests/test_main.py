...
class TestLongestPalindrome(TestCase):
    ...
    def test_longest_palindrome_empty(self):
        text = ""
        self.assertEqual(SolutionLongestPalindrome.longest_palindrome(text), text)
    ...
    def test_longest_palindrome_two_different_letters(self):
        text = "ab"
        self.assertIn(SolutionLongestPalindrome.longest_palindrome(text), ["a", "b"])
    ...
    def test_longest_palindrome_three_different_letters(self):
        text = "abc"
        self.assertIn(SolutionLongestPalindrome.longest_palindrome(text), ["a", "b", "c"])

    def test_longest_palindrome_even(self):
        text = "dsrgbqwertyytrewqzbmkjuilj"
        self.assertEqual(SolutionLongestPalindrome.longest_palindrome(text), "qwertyytrewq")

    def test_longest_palindrome_odd(self):
        text = "piuuqwertytrewqfgj"
        self.assertEqual(SolutionLongestPalindrome.longest_palindrome(text), "qwertytrewq")

    def test_longest_palindrome_on_the_left(self):
        text = "asdfghjklkjhgfdsaqqweqweqweqrtyutiu"
        self.assertEqual(SolutionLongestPalindrome.longest_palindrome(text), "asdfghjklkjhgfdsa")
